...
public class Sender {
    ...
    init(_ ikm: Bytes, _ suite: CipherSuite, _ publicKey: PublicKey, _ info: Bytes) throws {
    ...
    // Only for use from the testsuite to supply ikm
    init(_ ikm: Bytes, _ suite: CipherSuite, _ publicKey: PublicKey, _ info: Bytes, _ psk: Bytes, _ pskId: Bytes) throws {
        try suite.checkPubKey(publicKey)
    ...
    // Only for use from the testsuite to supply ikm
    init(_ ikm: Bytes, _ suite: CipherSuite, _ publicKey: PublicKey, _ info: Bytes, _ authentication: PrivateKey) throws {
        try suite.checkPubKey(publicKey)
    ...
    // Only for use from the testsuite to supply ikm
    init(_ ikm: Bytes, _ suite: CipherSuite, _ publicKey: PublicKey, _ info: Bytes, _ authentication: PrivateKey, _ psk: Bytes, _ pskId: Bytes) throws {
        try suite.checkPubKey(publicKey)
        try suite.checkPrivKey(authentication)
        guard CipherSuite.checkPsk(psk, pskId) else {
            throw HPKEException.pskError
