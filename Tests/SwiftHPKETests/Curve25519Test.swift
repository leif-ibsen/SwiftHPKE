...
final class Curve25519Test: XCTestCase {
    ...
    func test1() throws {
        ...
        XCTAssertEqual(try Curve25519.X25519(k1, u1), hex2bytes("c3da55379de9c6908e94ea4df28d084f32eccf03491c71f754b4075577a28552"))
        ...
        XCTAssertEqual(try Curve25519.X25519(k2, u2), hex2bytes("95cbde9476e8907d7aade45cb4b873f88b595a68799fa152e6f8f7647aac7957"))
    }
