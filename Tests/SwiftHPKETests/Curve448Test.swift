...
final class Curve448Test: XCTestCase {
    ...
    func test1() throws {
        let k1 = Base64.hex2bytes(
            "3d262fddf9ec8e88495266fea19a34d28882acef045104d0d1aae121700a779c984c24f8cdd78fbff44943eba368f54b29259a4f1c600ad3")!
        let u1 = Base64.hex2bytes(
            "06fce640fa3487bfda5f6cf2d5263f8aad88334cbd07437f020f08f9814dc031ddbdc38c19c6da2583fa5429db94ada18aa7a7fb4ef8a086")!
        XCTAssertEqual(try Curve448.X448(k1, u1), Base64.hex2bytes(
            "ce3e4ff95a60dc6697da1db1d85e6afbdf79b50a2412d7546d5f239fe14fbaadeb445fc66a01b0779d98223961111e21766282f73dd96b6f"))
        let k2 = Base64.hex2bytes(
            "203d494428b8399352665ddca42f9de8fef600908e0d461cb021f8c538345dd77c3e4806e25f46d3315c44e0a5b4371282dd2c8d5be3095f")!
        let u2 = Base64.hex2bytes(
            "0fbcc2f993cd56d3305b0b7d9e55d4c1a8fb5dbb52f8e9a1e9b6201b165d015894e56c4d3570bee52fe205e28a78b91cdfbde71ce8d157db")!
        XCTAssertEqual(try Curve448.X448(k2, u2), Base64.hex2bytes(
    ...
    func test2() throws {
        ...
        XCTAssertEqual(k, Base64.hex2bytes(
